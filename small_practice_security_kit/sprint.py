...
def build_stage_statuses(profile: dict[str, Any], out_dir: Path, gaps: list[str]) -> list[dict[str, Any]]:
    ...
    stage_rows = [
        ...
        },
        {
            ...
            "artifact_refs": ["ephi-flow-map.md", "connected-device-inventory.md", "portal-api-flow-review.md"],
        ...
        },
        {
            ...
            "owner": profile["practice"]["technical_owner"],
            "artifact_refs": ["downtime-ransomware-tabletop.md", "incident-decision-log.md"],
